...
let createPage (content: XmlNode) : XmlNode =
    ...
    html [ _id "html" ; _lang "en"; ] [
        ...
        body [
            ...
            header [] [
                nav [ _class Bulma.navbar ; _role "navigation"; _ariaLabel "main navigation" ] [
                    div [ _class  Bulma.``navbar-brand`` ] [
                        a [
                            _role "button"
                            _class Bulma.``navbar-burger`` ; (attr "data-target" menuId)
                    ...
                    div [ _id menuId ; _class "navbar-menu" ] [
            ...
            // content should always be main [] [ your html here ]
            content
